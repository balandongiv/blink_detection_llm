...
\graphicspath{{../e_result/figures/}{../figures/}}
\makeatletter
\def\input@path{{../}}
\makeatother
...
\history{}
\doi{}
\title{Toward Principled Threshold Selection for Blink Region Detection in
Biological Signals: A Cross-Dataset Benchmark with LLM-Guided Candidate
Derivation}
