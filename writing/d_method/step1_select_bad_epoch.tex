...
The first stage of the proposed pipeline performs epoch-level screening using an autoreject-inspired threshold selection procedure. Its purpose is not to estimate
