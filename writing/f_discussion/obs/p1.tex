...
Under the primary Proposed-approach configuration, a 30-second epoch duration achieved the best
macro-F1 among the tested durations (20, 30, 40, 60, 120\,s), with performance remaining
stable across this range (macro-F1\,=\,82.00\% at 30\,s). Strategy comparisons showed
