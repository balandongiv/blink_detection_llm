"""Experiment 2 (Raja): per-channel strategy-comparison sweep, all_channel gate.

Replaces the old run_exp2_raja.py. Compares the same four conditions defined in
...
Output CSVs go to runs/exp2_raja/ by default.
...
Full sweep::
    ...
    python experiment_script/exp2_a_strategy_comparison_raja.py --out-dir runs/exp2_raja

Quick smoke test::

    python experiment_script/exp2_a_strategy_comparison_raja.py --max-sessions 1 --n-jobs 1
"""
...
from src.project_paths import EXP_SETUP_DIR, get_raja_paths, load_exp_config
...
DEFAULT_OUT_DIR  = REPO_ROOT / Path(_PATH_CFG["out_dirs"]["exp2"]["raja"])
...
# all_channel = every EEG channel (32 for Raja), matching channel_group_selection.yaml's
