...
Full sweep::
    ...
    python experiment_script/exp3_a_strategy_comparison_cao2018.py --out-dir runs/exp2_cao

Quick smoke test::

    python experiment_script/exp3_a_strategy_comparison_cao2018.py --max-sessions 1 --n-jobs 1
"""
