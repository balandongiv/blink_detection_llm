...
Full sweep::
    ...
    python experiment_script/exp3_a_strategy_comparison_raja.py --out-dir runs/exp2_raja

Quick smoke test::

    python experiment_script/exp3_a_strategy_comparison_raja.py --max-sessions 1 --n-jobs 1
"""
