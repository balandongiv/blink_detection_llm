...
Companion to Figure 5 (``res_exp1_fig_single_channel_boxplot_by_region.py``, formerly
``fig2_exp1_single_channel_boxplot.py``) and Figure 6 (``res_exp1_fig_single_channel_vs_montage_significance.py``,
formerly ``fig16_exp1_single_channel_stats.py``): Figure 5 shows absolute single-electrode
...
from res_exp1_fig_single_channel_boxplot_by_region import solo_frame, REGION_ORDER, REGION_LABEL  # noqa: E402
