...
``res_exp2_fig_f1_by_epoch_duration_fp1_fp2.py`` (formerly ``tab13_fig10_epoch_duration.py``) previously aggregated over channel subsets as well as
...
from res_exp2_fig_f1_by_epoch_duration_fp1_fp2 import REFERENCE_S, f1_by_duration  # noqa: E402
