...
Order::
    ...
    exp3_a_strategy_comparison_cao2018.py
    exp3_a_strategy_comparison_raja.py
    exp2_b_plot_pr_scatter.py
    -> analysis + plot sent to Telegram

    exp2_a_epoch_duration_cao2018.py
    exp2_a_epoch_duration_raja.py
...
def main() -> None:
    ...
    if not run_task(
        "exp2 Cao2018",
        [PYTHON, "experiment_script/exp3_a_strategy_comparison_cao2018.py", "--n-jobs", "1"],
        EXP2_CAO_OUT,
    ):
        return
    if not run_task(
        "exp2 Raja",
        [PYTHON, "experiment_script/exp3_a_strategy_comparison_raja.py", "--n-jobs", "1"],
        EXP2_RAJA_OUT,
    ):
        return
    ...
    if not run_task(
        "exp3 Cao2018",
        [PYTHON, "experiment_script/exp2_a_epoch_duration_cao2018.py", "--n-jobs", "1"],
        EXP3_CAO_OUT,
    ):
        return
    if not run_task(
        "exp3 Raja",
        [PYTHON, "experiment_script/exp2_a_epoch_duration_raja.py", "--n-jobs", "1"],
        EXP3_RAJA_OUT,
    ):
        return
