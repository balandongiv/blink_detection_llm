...
electrode scored inside the full 32-channel Proposed-Med run, coloured by scalp region.
...
SCRIPT = "fig13_exp1_subset_per_electrode.py"
...
def main() -> None:
    frames = {ds: subset_frame(ds) for ds in ["raja", "cao"]}
    build_figure(frames)
