...
THIS_WORK = (r"\textbf{This work (Proposed-Med)}", "Single frontopolar EEG",
             "Raja + Cao2018 driving", "Event-level overlap (IoU 0.1--0.2)",
             r"macro-$F_1$ 0.84 / 0.78")

SRC = "% Source: references_from_csv.bib + Related Work; script experiment_script/build_literature_comparison.py"
