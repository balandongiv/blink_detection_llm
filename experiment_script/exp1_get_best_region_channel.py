...
Usage (run from REPO ROOT, inside conda env double_threshold_algo):
    python experiment_script/exp1_get_best_region_channel.py              # reads runs_second_iteration/
    python experiment_script/exp1_get_best_region_channel.py runs         # reads the runs/ baseline
...
def main() -> None:
    ...
    yaml_lines = [
        "# Auto-generated by experiment_script/exp1_get_best_region_channel.py",
