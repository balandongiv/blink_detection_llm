...
MANIFEST: list[Artifact] = [
    ...
    Artifact("tab:exp1_channel_ablation", "table", ["e_result/tab_exp1_channel_ablation.tex"],
             "tab2_exp1_channel_ablation.py", _exp("exp1") + REGIONS,
             "per-channel mean over sessions (selection=='all_channel', centre=='median'); NO region aggregation",
             "Channel-by-channel detection performance for every electrode."),
    Artifact("tab:region_performance", "table+figure",
             ["e_result/tab_region_performance.tex",
              "figures/fig_region_performance.pdf", "figures/fig_region_performance.png"],
             "tab3_fig3_region_performance.py", _exp("exp1") + REGIONS,
             "per-channel values collapsed to coarse regions; frontopolar broken out",
             "Region-level means and the whole-scalp single-channel map."),
    ...
    Artifact("tab:count_agreement", "table+figure",
             ["e_result/tab_count_agreement.tex",
    ...
    Artifact("tab:channel_selection", "table+figure",
             ["e_result/tab_channel_selection.tex",
    ...
    Artifact("tab:epoch_duration", "table+figure",
             ["e_result/tab_effect_different_epoch_size.tex",
