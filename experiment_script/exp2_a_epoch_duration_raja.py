...
Full sweep::
    ...
    python experiment_script/exp2_a_epoch_duration_raja.py --out-dir runs/exp3_raja

Quick smoke test::

    python experiment_script/exp2_a_epoch_duration_raja.py --max-sessions 1 --n-jobs 1
"""
