...
Full sweep::
    ...
    python experiment_script/exp2_a_epoch_duration_cao2018.py --out-dir runs/exp3_cao

Quick smoke test::

    python experiment_script/exp2_a_epoch_duration_cao2018.py --max-sessions 1 --n-jobs 1
"""
