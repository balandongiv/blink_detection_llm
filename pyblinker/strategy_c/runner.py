...
def blink_position_strategy_c(
    ...
    **kwargs,
    ...
    """
    if isinstance(valid_epoch_indices, dict) and setting is None:
        setting = valid_epoch_indices
        valid_epoch_indices = None

    options = dict(setting or {})
    options.update(kwargs)

    prepared = detector_or_prepared
    return channel_results_strategy_c(prepared, prepared_or_valid_epoch_indices, **options)
