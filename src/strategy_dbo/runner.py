...
from .single_channel_autoreject import learn_strategy_dbo_thresholds


def scan_strategy_dbo_channels(
...
def channel_results_strategy_dbo(
    prepared: PreparedEpochDetectionInput,
    valid_epoch_indices: list[int],
    *,
    blink_params: dict | None = None,
    ...
    **blink_param_overrides,
    ...
    results, _threshold_result = scan_strategy_dbo_channels(
        prepared,
        valid_epoch_indices,
...
def blink_position_strategy_dbo(
    ...
    **kwargs,
    ...
    return channel_results_strategy_dbo(prepared, valid_epoch_indices, **options)
...
def run_stage1_candidate_scan(
    ...
    *,
    ...
    channel_results, threshold_result = scan_strategy_dbo_channels(
        prepared,
        valid_epoch_indices,
...
def get_blink(detector):
    ...
    selected_channel["strategy_dbo_candidate_source"] = selected_channel["candidate_source"]
    selected_channel["strategy_dbo_detection_threshold"] = selected_channel["scan_threshold"]
    selected_channel["strategy_dbo_raw_threshold"] = selected_channel["raw_threshold"]
    selected_channel["strategy_dbo_stage1_threshold_scope"] = detector.stage1_threshold_scope_
    selected_channel["strategy_dbo_stage1_threshold_learning_api"] = (
        detector.stage1_threshold_learning_api_
    )
    selected_channel["strategy_dbo_autoreject_method"] = detector.stage1_autoreject_method_
    selected_channel["strategy_dbo_stage1_candidate_count"] = selected_channel[
        "raw_candidate_count"
    ]
...
def epoch_detection_strategy_dbo_autoreject(
    epoch: mne.Epochs,
    ...
    **blink_param_overrides,
    ...
    method, scope = validate_strategy_dbo_options(
        autoreject_method=autoreject_method,
