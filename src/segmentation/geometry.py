...
from src.blinker.stroke_utils import max_pos_vel_frame
from src.fitutils.forking import corr, get_intersection, polyfit, polyval
...
def lines_intersection(
    *,
    ...
    from src.utils.velocity_utils import average_velocity
