...
These utilities compare predicted blink tables against ground-truth tables
and are independent of any specific detection strategy.
"""
...
def load_reference_blink_table(path: str | Path) -> pd.DataFrame:
    """Load the long-form ground-truth blink CSV used for validation."""
...
def filter_reference_to_valid_epochs(
    ...
    """Restrict the ground-truth table to the retained valid epochs."""
...
def match_blink_tables(
    ...
    *,
    ...
    """Greedily match predicted and ground-truth blink tables using peak-overlap."""
