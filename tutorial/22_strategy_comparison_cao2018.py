"""Strategy comparison — A, B, C, F across cao_2018 dataset.
...
def run_one(
    ...
    ground_truth = enrich_absolute_times(ground_truth_valid, EPOCH_DURATION_S)
            ...
            for future in as_completed(future_to_task):
                ...
                try:
                    ...
                    print(
                        ...
                        f"  valid={result['n_valid']}/{result['n_valid']+result['n_dropped']}"
                        f"  f1={result['f1']:.4f}"
                    )
